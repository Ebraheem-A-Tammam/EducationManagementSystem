...
urlpatterns = [
    ...
    path('categories/<slug:slug>/edit/',admin_update_category,name='edit_category'),
    path('categories/<slug:slug>/delete/',admin_delete_category,name='delete_category'),
    ...
    path('<slug:slug>/edit/',admin_update_quiz,name='edit_quiz'),
    path('<slug:slug>/detail/',admin_quiz_detail_view,name='quiz_detail'),
    path('<slug:slug>/delete/',admin_delete_quiz,name='delete_quiz'),
    path('categories/<slug:slug>/', categorized_quiz_list_view, name='categorized_quiz_list'),
    path('categories/<slug:slug>/<slug:qslug>/', quiz_detail_view, name='quiz_detail'),
    path('categories/<slug:slug>/<slug:qslug>/result/<slug:submission_id>/', quiz_result_view, name='quiz_result'),
